...
import contactbg from "../../Assests/Images/contact.png";
...
const ContactForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const body = encodeURIComponent("Hello, I would like to get in touch regarding...");
      ...
      <div className={styles.card}>
        ...
        <div className={styles.leftPanel}>
          ...
          <div className={styles.contactItem}>
            <span className={styles.emailIcon}><i className="fa-regular fa-envelope"></i></span>
            <a title='email' href="mailto:sales@hyproc-intl.com" className={styles.emailIcon}>
            ...
            <div className={styles.contactItem}>
              ...
              <span>Hyproc International Limited Eagle Court 9 Vine Road Uxbridge UB8 1QE</span>
            </div>
